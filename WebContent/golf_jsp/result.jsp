			...
			<div class="wrapper">
				<div class="table-outer">
					<table class="table table-striped table-hover">
						...
						<%-- 강사 정보와 매출 정보를 함께 조회하기 --%>
						<%
							Tbl_teacher_Dao teacherDao = new Tbl_teacher_Dao();
							List<Tbl_teacher_Dto> teachers = teacherDao.getclasss();
							for (Tbl_teacher_Dto teacher : teachers) {
								int totalSales = teacherDao.calculateTotalSales(teacher.getTeacher_code());
						%>
						<tr>
							<td><%=teacher.getTeacher_code()%></td>
							<td><%=teacher.getTeacher_name()%></td>
							<td><%=teacher.getClass_name()%></td>
							<td><%=teacher.getClass_price()%></td>
							<td><%=teacher.getTeacher_regist_date()%></td>
							<td><%=totalSales%></td>
						</tr>
						<%
							}
