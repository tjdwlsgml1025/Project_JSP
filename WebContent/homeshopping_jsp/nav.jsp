				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="${pageContext.request.contextPath}/golf/teacher.jsp">강사조회</a></li>
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="#">골프홈</a></li>
							<li><a class="dropdown-item" href="#">강사조회</a></li>
							<li><a class="dropdown-item" href="#">수강신청</a></li>
							<li><a class="dropdown-item" href="#">회원정보조회</a></li>
							<li><a class="dropdown-item" href="#">강사매출현황</a></li>
						</ul></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" role="button"
